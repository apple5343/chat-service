...
- **User Service** — хранит данные пользователей, управляет процессами аутентификации и авторизации
...
Для отправки сообщения в чат по WebSocket, нужно использовать следующий JSON-объект:
